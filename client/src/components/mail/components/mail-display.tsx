...
export function MailDisplay({ mail }: MailDisplayProps) {
  ...
  const handleSendMail = async (event: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
    try {
      event.preventDefault()
      console.log("1");
      const response = await axios.post('http://localhost:8000/api/v1/sendMailButton', formData);
